...
model_urls = {
    ...
    "resnet18_v2": "https://download.pytorch.org/models/resnet18-f37072fd.pth",
...
class ResNet(nn.Module):
    def __init__(
        ...
        if not imagenet:
            ...
            print("imagenet architecture enabled!")
            self.conv1 = nn.Conv2d(
...
def _resnet(arch, block, layers, pretrained, progress, **kwargs):
    ...
    if pretrained:
        ...
        state_dict['normalize.mean'] = normalization.state_dict()['mean']
        state_dict['normalize.std'] = normalization.state_dict()['std']
